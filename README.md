...
🎟 Второй проект выполненный в ходе изучения курса "[Аренда жилья](https://github.com/agdobrynin/laravel-bnb)" 
co стеком технологий - Php 8.2 + Laravel 9, Vue 3 + TypeScript + Pug + Pinia, Boostrap css 5, MariaDb
